...
<html lang="en" >
	...
	<head>
		<meta charset="utf-8" />
		<title>
			Aqui financiamentos | Login Administração
		</title>
		<meta name="description" content="Login da gerencia da Aqui Financiamentos">
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default"  >
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--singin m-login--2 m-login-2--skin-3" id="m_login" style="background-image: url(/layout/metronic_v5.0.3/theme/dist/html/default/assets/app/media/img//bg/bg-2.jpg);">
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						...
						<div class="m-login__signin">
							<div class="m-login__head">
								<h3 class="m-login__title">
									Acesso à Área Gerencial
								</h3>
							</div>
							<form class="m-login__form m-form" action="autenticaLoja.php">
								<div class="form-group m-form__group">
									<input class="form-control m-input"   type="text" placeholder="Usuário" name="email" autocomplete="off">
								</div>
								<div class="form-group m-form__group">
						...
						<!-- <div class="m-login__signup" hidden>
							<div class="m-login__head">
								<h3 class="m-login__title">
									Sign Up
								</h3>
