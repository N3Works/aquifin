<div id="calculo">
  <table>
    <tr id="val"><td>Valor*:</td><td><input type="text" id="valor" name="valor" /></td></tr>
...
<script>
  ...
  function calcula(){
    ...
    if(valor>0){
      parcela = (valor + tc) * indice;
      campoParcela.value = parcela;
    }else{
      valor = parcela/indice - tc;
   ...
   for(var i=0; i<b.length;i++){
    ...
    document.getElementById('valorop').value = valor;
    document.getElementById('parcelaop').value = parcela;
