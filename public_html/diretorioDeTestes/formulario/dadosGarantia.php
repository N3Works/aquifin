<ul class="etapa">
	...
	<div class="categoria">
		...
		<li>Ano de Fabricação<span class="obrigatorio">*</span> <br /><input id="fabricacao" type="number" size="5" maxlength="4" name="fabricacao" min="1980" max="2012"></li>
		<li>Ano do Modelo<span class="obrigatorio">*</span> <br /><input id="amodelo" type="number" size="5" maxlength="4" name="amodelo" min="1980" max="2013"></li>                
	</div>
	<div class="categoria">
		<li id="hasPlaca">Placa<span class="obrigatorio">*</span><br /><input id="placa" name="placa" type='text' maxlength="7" size="8" /></li> 
		<li>Chassi <br /><input name="chassi" type='text' size="10"/></li>
		<li id="hasRenavam">Renavam<span class="obrigatorio">*</span> <br /><input id="renavam" name="renavam" maxlength="9" type='text' size="10"/></li>                     
	</div>
	<div class="categoria">
