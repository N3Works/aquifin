<ul class="etapa">
  ...
  <div class="categoria">
    <li>Telefone<br />  <input  onkeyup="avancaDDD('telempconj', false)" id="dddtelempconj" name="dddtelempconj" type='text' style="width:20px;" size="2" maxlength="2" /><input id="telempconj" name="telempconj" type='text' size="10" maxlength="9" /></li>
  </div>
  <div class="categoria">
