<ul class="etapa">
  ...
  <div class="categoria">
    <li>Telefone<span class="obrigatorio">*</span><br />  <input onkeyup="avancaDDD('telemp', false)" id="dddtelemp" name="dddtelemp" type='text' style="width:20px;" size="2" maxlength="2" /><input id="telemp" name="telemp" type='text' size="10" maxlength="9" /></li>
  </div>
  <div class="categoria">
  ...
  <div class="categoria">
    <li>Renda Bruta<span class="obrigatorio">*</span> <br /><input id="rendab" class="money" name="rendab" type='text' /></li>
    <li>Renda Líquida <br /><input id="rendal" class="money" name="rendal" type='text' /></li>
  </div>
</ul>