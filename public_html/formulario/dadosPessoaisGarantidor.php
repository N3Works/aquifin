<ul class="etapa">
  ...
  <li>Órgão Emissor <br /><input name="emissorconj" type='text' size="11"  /></li>
  ...
  <li>Telefone Fixo<br />  <input  onkeyup="avancaDDD('telfixoconj', false)" id="dddtelfixoconj" name="dddtelfixoconj" type='text' style="width:20px;" size="2" maxlength="2" /><input id="telfixoconj" name="telfixoconj" type='text' size="10" maxlength="9" /></li>
  <li>Celular<br />  <input  onkeyup="avancaDDD('celularconj', true)" id="dddcelularconj" name="dddcelularconj" type='text' style="width:20px;" size="2" maxlength="2" /><input id="celularconj" name="celularconj" type='text' size="10" maxlength="9" /></li>
