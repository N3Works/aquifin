...
if (isset($_POST['txtdest']))
{
	...
	$headers .= "From: contato@aquifinanciamentos.com.br".$quebra; //E-mail do remetente
	$headers .= "Return-Path: contato@aquifinanciamentos.com.br".$quebra; //E-mail do remetente
	mail($destino, $assunto, $mensagem, $headers, "-r". "contato@aquifinanciamentos.com.br");
