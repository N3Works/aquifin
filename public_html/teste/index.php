...
If (isset($_POST['txtdest']))
{
    ...
    $mailer->Host = 'smtp.aquifinanciamentos.com.br'; //smtp.dominio.com.br
    $mailer->SMTPAuth = true; //define se haverá ou não autenticação no SMTP
    $mailer->Username = 'contato@aquifinanciamentos.com.br'; //Informe o e-mai o completo
    $mailer->Password = 'teste'; //Senha da caixa postal
    $mailer->FromName = $assunto; //Nome que será exibido para o destinatário
    $mailer->From = 'contato@aquifinanciamentos.com.br'; //Obrigatório ser a mesma caixa postal indicada em "username"
